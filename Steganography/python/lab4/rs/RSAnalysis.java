 ...
 * <P>
 * RS analysis is a system for detecting LSB steganography proposed by Dr.
 * Fridrich at Binghamton University, NY. You can visit her webpage for more
 * information - {@link http://www.ws.binghamton.edu/fridrich/} <BR>
 * Implemented as described in "Reliable detection of LSB steganography in color
 * and grayscale images" by J. Fridrich, M. Goljan and R. Du.
 * <BR>
 * This code was produced with the aid of the authors and has been verified as a
...
public class RSAnalysis extends PixelBenchmark {
     ...
     *
     * Each alternating bit is set to 1. Eg for a mask of size 2x2 the resulting
     * mask will be {1,0;0,1}. Two masks are used - one is the inverse of the
     * other.
     *
     ...
     * <P>
     * The analysis data returned is specified by name in the getResultNames()
     * method.
     *
    ...
    /**
     * Gets the x value for the p=x(x/2) RS equation. See the paper for more
     * details.
     *
    ...
    /**
     * Gets the variation of the blocks of data. Uses the formula f(x) = |x0 -
     * x1| + |x1 + x3| + |x3 - x2| + |x2 - x0|; However, if the block is not in
     * the shape 2x2 or 4x1, this will be applied as many times as the block can
    ...
    /**
     * Gets the negative variation of the blocks of data. Uses the formula f(x)
     * = |x0 - x1| + |x1 + x3| + |x3 - x2| + |x2 - x0|; However, if the block is
     * not in the shape 2x2 or 4x1, this will be applied as many times as the
    ...
    /**
     * A small main method that will print out the message length in percent of
     * pixels.
     *
     */
